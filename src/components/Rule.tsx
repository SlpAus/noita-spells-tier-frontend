    ...
    return (
        <Box className="space-y-4">
            ...
            <p className={`text-xl font-bold text-red-300 animate-slide-fade`}>
                ...
                3. 对每个IP添加了一分钟上限投票90次的限制，并且修改了部分后端API来防止恶意刷票，制作网站不易，本不希望用冷冰冰的频率限制大家的热情，但是由于有人恶意刷票，不得已而为之，希望大家理解！也希望以撒圈子风气越来越好！(某IP为120.XXX.146.65的用户在短时间内刷了近5w次投票，且给几乎所有四级道具刷了1k多条负票，已在维护时清除了这些投票)
            </p>
