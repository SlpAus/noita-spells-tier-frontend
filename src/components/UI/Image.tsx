...
const Image = (props: { image_prop: image }) => {
    ...
    return (
        <div className="rounded-2xl flex flex-col  items-center hover:shadow-lg transition-shadow duration-300 hover:bg-gray-100 hover:bg-opacity-[10%]">
            ...
            {image_prop.description ? (
                <div className="text-base  w-full p-2 shadow-md hover:bg-red-600 hover:text-white transition-colors duration-300">
                    {image_prop.description}
                </div>
            ) : null}
        </div>
